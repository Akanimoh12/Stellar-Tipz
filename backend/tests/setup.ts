...
// Mock environment variables for testing before any app module imports
...
process.env.AUTH_CHALLENGE_CLEANUP_CRON ||= '*/5 * * * *';
process.env.AUTH_RATE_LIMIT_PER_IP ||= '30';
process.env.AUTH_RATE_LIMIT_PER_ADDRESS ||= '10';
